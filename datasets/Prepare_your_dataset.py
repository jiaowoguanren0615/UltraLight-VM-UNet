...
for idx in range(len(Tr_list)):
    ...
    b = b[len(b) - 8: len(b) - 4]
    add = (
                "masks/" + b + '.png')  # Masks storage folder. The Mask type should be a black and white image of an 8-bit png (0 pixels for the background and 255 pixels for the target).
    img2 = sc.imread(add)
